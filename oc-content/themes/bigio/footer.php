...
<footer id="footer" class="row">
        ...
        ?></p>
							...
							<div class="col-lg-4 col-md-4 col-sm-4">
                                ...
                                Credits: <a href="http://wordpressthemes.xyz">WP</a> <a href="http://themehelp.us/" title="Premium WordPress Themes">Themes</a>
								</ul>
							</div>
...
<script type="text/javascript">
    ...
    function doSearch() {
		...
		<script src="<?php echo osc_current_web_theme_url('js/modernizr.min.js') ; ?>"></script>
		<script src="<?php echo osc_current_web_theme_url('js/perfect-scrollbar.min.js') ; ?>"></script>
		<script src="<?php echo osc_current_web_theme_url('js/zoomsl-3.0.min.js') ; ?>"></script>
        <script src="<?php echo osc_current_web_theme_url('js/chosen.jquery.min.js') ; ?>" type="text/javascript"></script>
        <script defer src="<?php echo osc_current_web_theme_url('js/bootstrap.min.js') ; ?>"></script>
        <script src="<?php echo osc_current_web_theme_url('js/main-script.js') ; ?>"></script>
